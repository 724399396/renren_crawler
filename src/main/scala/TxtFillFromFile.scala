...
object TxtFillFromFile extends App {
  ...
  val files = face.Util.subFiles(new File("D:/work/photos-true/message-generator/%d".format(age))).toList
  val out = new PrintWriter("D:/work/photos-true/message-generator/%d.txt".format(age))
